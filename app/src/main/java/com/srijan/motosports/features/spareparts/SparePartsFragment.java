...
public class SparePartsFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        RecyclerView rvItems = (RecyclerView)getView().findViewById(R.id.rvItems);

        List<Object> sparePartsItems = new ArrayList<Object>() ;
        SparePartsItem spItem[] = new SparePartsItem[4];
        Bitmap images[] = new Bitmap[4];
        Bitmap image = BitmapFactory.decodeResource(getResources(),R.drawable.img_na);
        ...
        spChild[0] = new SparePartsChildItem("Fox DHX 5.0","Lower,$210",210,image);
        spChild[1] = new SparePartsChildItem("Ohlins TTX 25","Standard,$450",450,image);
        spChild[2] = new SparePartsChildItem("Ohlins TTX 36","Higher,$500",500,image);
        spChild[3] = new SparePartsChildItem("Quantum (Two zroo)","Two Way adjustable,$325",325,image);
